...
int main() {
  string s;
  cin >> s;
  ll si = 0, ssize = s.size();
  bool ans = true;
  while (si < ssize) {
    //cout << si << endl;
    //cout << s.substr(si, 5) << endl;
    if (s.substr(si, 5) == "dream") {
      if (s.substr(si + 5, 5) == "erase") {
        si += 5;
      } else if (s.substr(si + 5,2) == "er") {
        si += 7;
      } else {
        si += 5;
      }
      //cout << si << endl;
    } else if (s.substr(si,5) == "erase") {
      if (s.substr(si + 5, 1) == "r") {
        si += 6;
      } else {
        si += 5;
      }
